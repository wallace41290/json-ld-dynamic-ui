...
import { FilterResourcePropertiesPipeModule } from '@app/shared/pipes';
...
@NgModule({
  imports: [CommonModule, FilterResourcePropertiesPipeModule, GenericPropertyViewerModule, MatIconModule, MatListModule],
