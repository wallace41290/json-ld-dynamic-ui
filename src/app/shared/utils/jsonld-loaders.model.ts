...
import { CacheInterceptor } from '@app/shared/services/cache-interceptor.service';
...
export function getHttpClientLoader(
  ...
  clearCache = false
): (url: jsonldSpec.Url, callback: (err: Error, remoteDoc: jsonldSpec.RemoteDocument) => void) => Promise<jsonldSpec.RemoteDocument> {
